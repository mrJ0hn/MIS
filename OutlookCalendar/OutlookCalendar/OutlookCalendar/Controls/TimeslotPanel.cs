    ...
    public class TimeslotPanel : Panel
    {
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            foreach (UIElement element in this.Children)
            {
                ...
                double start_minutes = ((startTime.Value.Hour - 8) * 60) + startTime.Value.Minute;
                double end_minutes = ((endTime.Value.Hour - 8) * 60) + endTime.Value.Minute;
                double start_offset = (finalSize.Height / (13 * 60)) * start_minutes;
                double end_offset = (finalSize.Height / (13 * 60)) * end_minutes;
